...
PROTOBUF_NAMESPACE_OPEN
template<> ::ProtMes::FastResponse* Arena::CreateMaybeMessage<::ProtMes::FastResponse>(Arena*);
template<> ::ProtMes::RequestForFastResponse* Arena::CreateMaybeMessage<::ProtMes::RequestForFastResponse>(Arena*);
template<> ::ProtMes::RequestForSlowResponse* Arena::CreateMaybeMessage<::ProtMes::RequestForSlowResponse>(Arena*);
template<> ::ProtMes::SlowResponse* Arena::CreateMaybeMessage<::ProtMes::SlowResponse>(Arena*);
template<> ::ProtMes::WrapperMessage* Arena::CreateMaybeMessage<::ProtMes::WrapperMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ProtMes {
...
class WrapperMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtMes.WrapperMessage) */ {
 public:
  ...
  const ::ProtMes::FastResponse& fast_response() const;
  ::ProtMes::FastResponse* release_fast_response();
  ::ProtMes::FastResponse* mutable_fast_response();
  void set_allocated_fast_response(::ProtMes::FastResponse* fast_response);
  private:
  const ::ProtMes::FastResponse& _internal_fast_response() const;
  ::ProtMes::FastResponse* _internal_mutable_fast_response();
  public:
  void unsafe_arena_set_allocated_fast_response(
      ::ProtMes::FastResponse* fast_response);
  ::ProtMes::FastResponse* unsafe_arena_release_fast_response();
  ...
  const ::ProtMes::SlowResponse& slow_response() const;
  ::ProtMes::SlowResponse* release_slow_response();
  ::ProtMes::SlowResponse* mutable_slow_response();
  void set_allocated_slow_response(::ProtMes::SlowResponse* slow_response);
  private:
  const ::ProtMes::SlowResponse& _internal_slow_response() const;
  ::ProtMes::SlowResponse* _internal_mutable_slow_response();
  public:
  void unsafe_arena_set_allocated_slow_response(
      ::ProtMes::SlowResponse* slow_response);
  ::ProtMes::SlowResponse* unsafe_arena_release_slow_response();
  ...
  const ::ProtMes::RequestForFastResponse& request_for_fast_response() const;
  ::ProtMes::RequestForFastResponse* release_request_for_fast_response();
  ::ProtMes::RequestForFastResponse* mutable_request_for_fast_response();
  void set_allocated_request_for_fast_response(::ProtMes::RequestForFastResponse* request_for_fast_response);
  private:
  const ::ProtMes::RequestForFastResponse& _internal_request_for_fast_response() const;
  ::ProtMes::RequestForFastResponse* _internal_mutable_request_for_fast_response();
  public:
  void unsafe_arena_set_allocated_request_for_fast_response(
      ::ProtMes::RequestForFastResponse* request_for_fast_response);
  ::ProtMes::RequestForFastResponse* unsafe_arena_release_request_for_fast_response();
  ...
  const ::ProtMes::RequestForSlowResponse& request_for_slow_response() const;
  ::ProtMes::RequestForSlowResponse* release_request_for_slow_response();
  ::ProtMes::RequestForSlowResponse* mutable_request_for_slow_response();
  void set_allocated_request_for_slow_response(::ProtMes::RequestForSlowResponse* request_for_slow_response);
  private:
  const ::ProtMes::RequestForSlowResponse& _internal_request_for_slow_response() const;
  ::ProtMes::RequestForSlowResponse* _internal_mutable_request_for_slow_response();
  public:
  void unsafe_arena_set_allocated_request_for_slow_response(
      ::ProtMes::RequestForSlowResponse* request_for_slow_response);
  ::ProtMes::RequestForSlowResponse* unsafe_arena_release_request_for_slow_response();

  // @@protoc_insertion_point(class_scope:ProtMes.WrapperMessage)
 private:
  class _Internal;
  ...
  ::ProtMes::FastResponse* fast_response_;
  ::ProtMes::SlowResponse* slow_response_;
  ::ProtMes::RequestForFastResponse* request_for_fast_response_;
  ::ProtMes::RequestForSlowResponse* request_for_slow_response_;
  friend struct ::TableStruct_message_2eproto;
};
// -------------------------------------------------------------------

class FastResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtMes.FastResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ProtMes.FastResponse)
 private:
  class _Internal;
...
class SlowResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtMes.SlowResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ProtMes.SlowResponse)
 private:
  class _Internal;
...
class RequestForFastResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtMes.RequestForFastResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ProtMes.RequestForFastResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:ProtMes.RequestForFastResponse)
 private:
  class _Internal;
...
class RequestForSlowResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtMes.RequestForSlowResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ProtMes.RequestForSlowResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:ProtMes.RequestForSlowResponse)
 private:
  class _Internal;
...
inline const ::ProtMes::FastResponse& WrapperMessage::_internal_fast_response() const {
  const ::ProtMes::FastResponse* p = fast_response_;
  return p != nullptr ? *p : *reinterpret_cast<const ::ProtMes::FastResponse*>(
      &::ProtMes::_FastResponse_default_instance_);
}
inline const ::ProtMes::FastResponse& WrapperMessage::fast_response() const {
  // @@protoc_insertion_point(field_get:ProtMes.WrapperMessage.fast_response)
...
inline void WrapperMessage::unsafe_arena_set_allocated_fast_response(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProtMes.WrapperMessage.fast_response)
}
inline ::ProtMes::FastResponse* WrapperMessage::release_fast_response() {
...
inline ::ProtMes::FastResponse* WrapperMessage::unsafe_arena_release_fast_response() {
  // @@protoc_insertion_point(field_release:ProtMes.WrapperMessage.fast_response)
  _has_bits_[0] &= ~0x00000001u;
  ::ProtMes::FastResponse* temp = fast_response_;
  fast_response_ = nullptr;
  return temp;
}
inline ::ProtMes::FastResponse* WrapperMessage::_internal_mutable_fast_response() {
  _has_bits_[0] |= 0x00000001u;
  if (fast_response_ == nullptr) {
    auto* p = CreateMaybeMessage<::ProtMes::FastResponse>(GetArena());
    fast_response_ = p;
  }
  return fast_response_;
}
inline ::ProtMes::FastResponse* WrapperMessage::mutable_fast_response() {
  // @@protoc_insertion_point(field_mutable:ProtMes.WrapperMessage.fast_response)
  return _internal_mutable_fast_response();
}
inline void WrapperMessage::set_allocated_fast_response(::ProtMes::FastResponse* fast_response) {
  ...
  fast_response_ = fast_response;
  // @@protoc_insertion_point(field_set_allocated:ProtMes.WrapperMessage.fast_response)
}
...
inline const ::ProtMes::SlowResponse& WrapperMessage::_internal_slow_response() const {
  const ::ProtMes::SlowResponse* p = slow_response_;
  return p != nullptr ? *p : *reinterpret_cast<const ::ProtMes::SlowResponse*>(
      &::ProtMes::_SlowResponse_default_instance_);
}
inline const ::ProtMes::SlowResponse& WrapperMessage::slow_response() const {
  // @@protoc_insertion_point(field_get:ProtMes.WrapperMessage.slow_response)
...
inline void WrapperMessage::unsafe_arena_set_allocated_slow_response(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProtMes.WrapperMessage.slow_response)
}
inline ::ProtMes::SlowResponse* WrapperMessage::release_slow_response() {
...
inline ::ProtMes::SlowResponse* WrapperMessage::unsafe_arena_release_slow_response() {
  // @@protoc_insertion_point(field_release:ProtMes.WrapperMessage.slow_response)
  _has_bits_[0] &= ~0x00000002u;
  ::ProtMes::SlowResponse* temp = slow_response_;
  slow_response_ = nullptr;
  return temp;
}
inline ::ProtMes::SlowResponse* WrapperMessage::_internal_mutable_slow_response() {
  _has_bits_[0] |= 0x00000002u;
  if (slow_response_ == nullptr) {
    auto* p = CreateMaybeMessage<::ProtMes::SlowResponse>(GetArena());
    slow_response_ = p;
  }
  return slow_response_;
}
inline ::ProtMes::SlowResponse* WrapperMessage::mutable_slow_response() {
  // @@protoc_insertion_point(field_mutable:ProtMes.WrapperMessage.slow_response)
  return _internal_mutable_slow_response();
}
inline void WrapperMessage::set_allocated_slow_response(::ProtMes::SlowResponse* slow_response) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
  ...
  slow_response_ = slow_response;
  // @@protoc_insertion_point(field_set_allocated:ProtMes.WrapperMessage.slow_response)
}
...
inline const ::ProtMes::RequestForFastResponse& WrapperMessage::_internal_request_for_fast_response() const {
  const ::ProtMes::RequestForFastResponse* p = request_for_fast_response_;
  return p != nullptr ? *p : *reinterpret_cast<const ::ProtMes::RequestForFastResponse*>(
      &::ProtMes::_RequestForFastResponse_default_instance_);
}
inline const ::ProtMes::RequestForFastResponse& WrapperMessage::request_for_fast_response() const {
  // @@protoc_insertion_point(field_get:ProtMes.WrapperMessage.request_for_fast_response)
...
inline void WrapperMessage::unsafe_arena_set_allocated_request_for_fast_response(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProtMes.WrapperMessage.request_for_fast_response)
}
inline ::ProtMes::RequestForFastResponse* WrapperMessage::release_request_for_fast_response() {
...
inline ::ProtMes::RequestForFastResponse* WrapperMessage::unsafe_arena_release_request_for_fast_response() {
  // @@protoc_insertion_point(field_release:ProtMes.WrapperMessage.request_for_fast_response)
  _has_bits_[0] &= ~0x00000004u;
  ::ProtMes::RequestForFastResponse* temp = request_for_fast_response_;
  request_for_fast_response_ = nullptr;
  return temp;
}
inline ::ProtMes::RequestForFastResponse* WrapperMessage::_internal_mutable_request_for_fast_response() {
  _has_bits_[0] |= 0x00000004u;
  if (request_for_fast_response_ == nullptr) {
    auto* p = CreateMaybeMessage<::ProtMes::RequestForFastResponse>(GetArena());
    request_for_fast_response_ = p;
  }
  return request_for_fast_response_;
}
inline ::ProtMes::RequestForFastResponse* WrapperMessage::mutable_request_for_fast_response() {
  // @@protoc_insertion_point(field_mutable:ProtMes.WrapperMessage.request_for_fast_response)
  return _internal_mutable_request_for_fast_response();
}
inline void WrapperMessage::set_allocated_request_for_fast_response(::ProtMes::RequestForFastResponse* request_for_fast_response) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
  ...
  request_for_fast_response_ = request_for_fast_response;
  // @@protoc_insertion_point(field_set_allocated:ProtMes.WrapperMessage.request_for_fast_response)
}
...
inline const ::ProtMes::RequestForSlowResponse& WrapperMessage::_internal_request_for_slow_response() const {
  const ::ProtMes::RequestForSlowResponse* p = request_for_slow_response_;
  return p != nullptr ? *p : *reinterpret_cast<const ::ProtMes::RequestForSlowResponse*>(
      &::ProtMes::_RequestForSlowResponse_default_instance_);
}
inline const ::ProtMes::RequestForSlowResponse& WrapperMessage::request_for_slow_response() const {
  // @@protoc_insertion_point(field_get:ProtMes.WrapperMessage.request_for_slow_response)
...
inline void WrapperMessage::unsafe_arena_set_allocated_request_for_slow_response(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProtMes.WrapperMessage.request_for_slow_response)
}
inline ::ProtMes::RequestForSlowResponse* WrapperMessage::release_request_for_slow_response() {
...
inline ::ProtMes::RequestForSlowResponse* WrapperMessage::unsafe_arena_release_request_for_slow_response() {
  // @@protoc_insertion_point(field_release:ProtMes.WrapperMessage.request_for_slow_response)
  _has_bits_[0] &= ~0x00000008u;
  ::ProtMes::RequestForSlowResponse* temp = request_for_slow_response_;
  request_for_slow_response_ = nullptr;
  return temp;
}
inline ::ProtMes::RequestForSlowResponse* WrapperMessage::_internal_mutable_request_for_slow_response() {
  _has_bits_[0] |= 0x00000008u;
  if (request_for_slow_response_ == nullptr) {
    auto* p = CreateMaybeMessage<::ProtMes::RequestForSlowResponse>(GetArena());
    request_for_slow_response_ = p;
  }
  return request_for_slow_response_;
}
inline ::ProtMes::RequestForSlowResponse* WrapperMessage::mutable_request_for_slow_response() {
  // @@protoc_insertion_point(field_mutable:ProtMes.WrapperMessage.request_for_slow_response)
  return _internal_mutable_request_for_slow_response();
}
inline void WrapperMessage::set_allocated_request_for_slow_response(::ProtMes::RequestForSlowResponse* request_for_slow_response) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
  ...
  request_for_slow_response_ = request_for_slow_response;
  // @@protoc_insertion_point(field_set_allocated:ProtMes.WrapperMessage.request_for_slow_response)
}
...
inline const std::string& FastResponse::current_date_time() const {
  // @@protoc_insertion_point(field_get:ProtMes.FastResponse.current_date_time)
...
inline void FastResponse::set_current_date_time(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:ProtMes.FastResponse.current_date_time)
}
inline std::string* FastResponse::mutable_current_date_time() {
  // @@protoc_insertion_point(field_mutable:ProtMes.FastResponse.current_date_time)
...
inline void FastResponse::set_current_date_time(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:ProtMes.FastResponse.current_date_time)
}
inline void FastResponse::set_current_date_time(const char* value) {
  ...
  current_date_time_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ProtMes.FastResponse.current_date_time)
}
inline void FastResponse::set_current_date_time(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:ProtMes.FastResponse.current_date_time)
}
...
inline std::string* FastResponse::release_current_date_time() {
  // @@protoc_insertion_point(field_release:ProtMes.FastResponse.current_date_time)
...
inline void FastResponse::set_allocated_current_date_time(std::string* current_date_time) {
  ...
  current_date_time_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), current_date_time,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ProtMes.FastResponse.current_date_time)
}
inline std::string* FastResponse::unsafe_arena_release_current_date_time() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ProtMes.FastResponse.current_date_time)
...
inline void FastResponse::unsafe_arena_set_allocated_current_date_time(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProtMes.FastResponse.current_date_time)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 SlowResponse::connected_client_count() const {
  // @@protoc_insertion_point(field_get:ProtMes.SlowResponse.connected_client_count)
...
inline void SlowResponse::set_connected_client_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:ProtMes.SlowResponse.connected_client_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RequestForSlowResponse::time_in_seconds_to_sleep() const {
  // @@protoc_insertion_point(field_get:ProtMes.RequestForSlowResponse.time_in_seconds_to_sleep)
...
inline void RequestForSlowResponse::set_time_in_seconds_to_sleep(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:ProtMes.RequestForSlowResponse.time_in_seconds_to_sleep)
}
